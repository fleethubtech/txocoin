...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s txocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  txocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded txocoin transaction") + "\n" +
              "  txocoin-tx [options] -create [commands]   " + _("Create hex-encoded txocoin transaction") + "\n" +
              "\n";

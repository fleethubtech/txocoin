...
const char * const BITCOIN_CONF_FILENAME = "txocoin.conf";
const char * const BITCOIN_PID_FILENAME = "txocoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Txocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Txocoin";
#else
    // Unix
    return pathRet / ".txocoin";
#endif
#endif
}

...
* txocoin.conf: contains configuration settings for txocoind or txocoin-qt
* txocoind.pid: stores the process id of txocoind while running
...
* debug.log: contains debug information and general logging generated by txocoind or txocoin-qt

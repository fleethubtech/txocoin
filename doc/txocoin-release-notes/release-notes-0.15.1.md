Txocoin Core version *0.15.1* is now available from:

  <https://download.txocoin.org/txocoin-0.15.1/>
...
A number of changes to the way Txocoin Core deals with peer connections and invalid blocks

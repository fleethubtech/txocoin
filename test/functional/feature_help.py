...
"""Verify that starting txocoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start txocoin with -h for help text")
        ...
        self.log.info("Start txocoin with -version for version information")
